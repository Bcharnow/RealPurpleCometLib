...
namespace v2 {
	...
	static double cross(const v2::Vector2& a, const v2::Vector2& b) {
		return a.x * b.y - a.y * b.x;
	}
	Vector2 FromAng(float ang) {
		return v2::Vector2(cos(toRadians(ang)), sin(toRadians(ang)));
	}

	inline float Vector2::ang()
	{
